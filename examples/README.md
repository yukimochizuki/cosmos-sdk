...
There will be an error stating `can't load package: package github.com/yukimochizuki/cosmos-sdk: no Go files`, however you can ignore this error, it doesn't affect us. Now change directories to:
